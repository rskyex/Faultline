        ...
        <div className="relative md:hidden bg-deep/95 backdrop-blur-xl" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div className="px-6 py-5 space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2 pt-1">
              ...
              <a href="https://lunar-mandate-atlas.vercel.app/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-text-secondary text-[11px] tracking-[0.05em] py-1.5 hover:text-space-400 transition-colors">
                <span className="w-1 h-1 rounded-full bg-space-500/60" />Lunar Governance Authority Tracker
              </a>
