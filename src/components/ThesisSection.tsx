            ...
            <ScrollReveal delay={200}>
              <div className="relative lg:sticky lg:top-28">
                <svg viewBox="0 0 420 540" fill="none" className="w-full max-w-[420px]">
                  ...
                  <text x="76" y="82" fill="#4a6fa5" fontSize="9" fontFamily="Inter, sans-serif" opacity="0.55" letterSpacing="0.12em">ORBITAL INFRASTRUCTURE</text>
                  ...
                  <text x="76" y="232" fill="#6b8fc0" fontSize="9" fontFamily="Inter, sans-serif" opacity="0.55" letterSpacing="0.12em">NUCLEAR INFRASTRUCTURE</text>
                  ...
                  <text x="76" y="382" fill="#d4a843" fontSize="9" fontFamily="Inter, sans-serif" opacity="0.5" letterSpacing="0.12em">CYBER OPERATIONS</text>
                  ...
                  <text x="95" y="192" fill="#8eb0d8" fontSize="7" fontFamily="Inter, sans-serif" opacity="0.4" letterSpacing="0.05em">ESCALATION</text>
                  <text x="220" y="342" fill="#d4a843" fontSize="7" fontFamily="Inter, sans-serif" opacity="0.35" letterSpacing="0.05em">SPILLOVER</text>
                  ...
                  <text x="226" y="269" fill="#8eb0d8" fontSize="7.5" fontFamily="Inter, sans-serif" opacity="0.45" letterSpacing="0.08em">FAULT LINE</text>
                </svg>
              </div>
            </ScrollReveal>
          </div>
