...
export default function CenterpieceSection() {
  return (
    <section className="relative overflow-hidden">
      {/* Top: Image background header strip */}
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
          <ScrollReveal>
            <div className="text-center">
              ...
              <p className="mt-5 text-white/75 text-base max-w-lg mx-auto leading-relaxed">
      ...
      {/* Bottom: White background diagram area */}
            ...
            <div className="relative hidden md:flex justify-center">
              ...
              >
                ...
                <path d="M350 80 L400 180 L440 250 L480 290 L500 310 L520 345 L560 410 L610 500 L650 580"
                  stroke={C.steel[500]} strokeWidth="2.5" fill="none" opacity="0.3"
                  strokeLinecap="round" strokeLinejoin="round" filter="url(#cp-blur)" />
                <path d="M350 80 L400 180 L440 250 L480 290 L500 310 L520 345 L560 410 L610 500 L650 580"
                  stroke={C.steel[500]} strokeWidth="1.5" fill="none" opacity="0.45"
