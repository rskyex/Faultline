        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <ScrollReveal delay={0}>
            <div className="bg-white rounded-sm p-8 lg:p-10">
              ...
              <h3 className="text-lg font-semibold text-navy-950 mb-3">Cross-Domain Dependencies</h3>
          ...
          <ScrollReveal delay={100}>
            <div className="bg-white rounded-sm p-8 lg:p-10">
              ...
              <h3 className="text-lg font-semibold text-navy-950 mb-3">Escalation Transfer</h3>
              <p className="text-sm text-navy-600 leading-[1.75]">
                ...
                hypotheticals&mdash;they are structural features of interconnected systems.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={200}>
            <div className="bg-white rounded-sm p-8 lg:p-10">
              ...
              <h3 className="text-lg font-semibold text-navy-950 mb-3">Shared Pressure Points</h3>
              <p className="text-sm text-navy-600 leading-[1.75]">
          ...
          <ScrollReveal delay={300}>
            <div className="bg-white rounded-sm p-8 lg:p-10">
              ...
              <h3 className="text-lg font-semibold text-navy-950 mb-3">Governance Fragmentation</h3>
              <p className="text-sm text-navy-600 leading-[1.75]">
