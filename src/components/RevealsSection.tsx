      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-16">
          <ScrollReveal delay={0}>
            <div>
              <div className="flex items-center gap-4 mb-5">
                <span className="text-steel-500 text-xs font-medium tracking-[0.1em]">01</span>
          ...
          <ScrollReveal delay={100}>
            <div>
              <div className="flex items-center gap-4 mb-5">
                <span className="text-steel-400 text-xs font-medium tracking-[0.1em]">02</span>
          ...
          <ScrollReveal delay={200}>
            <div>
              <div className="flex items-center gap-4 mb-5">
                <span className="text-steel-300 text-xs font-medium tracking-[0.1em]">03</span>
          ...
          <ScrollReveal delay={300}>
            <div>
              <div className="flex items-center gap-4 mb-5">
                <span className="text-gold-400 text-xs font-medium tracking-[0.1em]">04</span>
